              ...
              <div className="d-lg-flex d-none">
                <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                  ...
                  <Link
                    ...
                    className="btn btn-wave btn-secondary"
                  >
                    Job Post
                  </Link>
                  <Button
                ...
                <Col xxl={7} xl={7} lg={8}>
                  <div className="">
                    <h5 className="landing-banner-heading mb-3">
                      <span className="text-secondary fw-bold">6000+ </span>
                      Jobs, Find your dream job
                    </h5>
                    <p className="fs-18 mb-5 op-8 fw-normal text-fixed-white">
                      Register & get free access to latest openings worldwide.
                      Create & submit your resume with few easy steps.
                    </p>
                    <div className="mb-3 custom-form-group">
                      ...
                      <div className="custom-form-btn">
                        <Link to="#" className="gps-location">
                ...
                <Card className="custom-card border">
                  <div className="row g-0">
                    <Col md={3} className="col-4">
                      <img
                        src={jobslanding1}
                        className="img-fluid rounded-start h-100 browse-jobs-image"
                        alt="..."
                      />
                    </Col>
                    <Col md={9} className="col-8 my-auto">
                      <Card.Body>
                        ...
                        <Link className="text-primary fw-semibold" to="#">
                          Explore Jobs
                          <i className="ri-arrow-right-s-line align-middle transform-arrow"></i>
                        </Link>
                      </Card.Body>
                    </Col>
                  </div>
              ...
              <div className="col-12 col-md-4">
                <Card className="custom-card border">
                  <Card.Body className="rounded">
                    ...
                    <h5 className="fw-semibold">Register Your Account</h5>
                    <p className="op-8">
                      Est amet sit vero sanctus labore no sed ipsum ipsum
                      nonumy. Sit ipsum sanctus ea.
                    </p>
                    <Link className="mx-1 text-primary fw-semibold" to="#">
                      Register Now
                      <i className="ri-arrow-right-s-line align-center transform-arrow"></i>
                    </Link>
                  </Card.Body>
                </Card>
              </div>
              <Col md={4} className="col-12">
                <Card className="custom-card border">
                  <Card.Body className="rounded">
                    ...
                    <h5 className="fw-semibold">Complete Your Profile</h5>
                    <p className="op-8">
                      Est amet sit vero sanctus labore no sed ipsum ipsum
                      nonumy. Sit ipsum sanctus ea.
                    </p>
              ...
              <Col md={4} className="col-12 col-md-4">
                <Card className="custom-card border">
                  <Card.Body className="rounded">
                    ...
                    <h5 className="fw-semibold">Apply job / Hire</h5>
                    <p className="op-8">
                      Est amet sit vero sanctus labore no sed ipsum ipsum
                      nonumy. Sit ipsum sanctus ea.
                    </p>
              ...
              <Col md={7} xl={8}>
                <div className="my-4">
                  <h2 className="fw-semibold mb-3 text-fixed-white">
                    ...
                    <Link
                      to="#"
                      className="text-fixed-white text-decoration-line"
                    >
                      {" "}
                      <u>drop</u>{" "}
                    </Link>{" "}
                ...
                <Card className="custom-card featured-jobs">
                  <Card.Body>
                    <div className="btn-list float-end">
                      ...
                      <Link
                        to="#"
                        className="wishlist-icon text-warning"
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        title="Featured Jobs"
                      >
                    ...
                    <div className="d-flex justify-content-between">
                      <h6 className="fw-semibold mb-0 text-default">
                        $25,000 - $35,000
                      </h6>
                      <Link
                        to=""
                        className="text-primary fw-semibold fs-14 d-inline-flex align-items-center"
                      >
                        Apply Now{" "}
                        <i className="fe fe-arrow-right transform-arrow"></i>
                      </Link>
                    </div>
                  </Card.Body>
                </Card>
        ...
        <section className="section bg-primary">
          <div className="container">
            <div className="row justify-content-center text-center mb-5 text-fixed-white">
              <Col xl={6}>
                <h3 className="fw-semibold mb-3 text-fixed-white">
              ...
              <Col lg={3} md={6} sm={6}>
                <Card className="card feature-style">
                  <Card.Body>
                    ...
                    <h5 className="mb-1 fw-semibold text-default">
                      Internship
                    </h5>
                    <p className="text-muted">120 Jobs Available</p>
                    <Link className="text-primary fw-semibold" to="#">
          ...
          <div className="container">
            <div className="row align-items-center justify-content-center">
              ...
              <Col md={8} className="my-4">
                ...
                <span className="mb-4 fs-15 fw-normal text-muted d-block">
                  Est amet sit vero sanctus labore no sed nonumy. Sit ipsum
                  sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit
                  ipsum ipsum.Est amet sit vero sanctus labore no sed ipsum
                  ipsum nonumy vero sanctus labore..{" "}
            ...
            <div className="row row-cols-1 row-cols-md-3 g-4">
              ...
              <div className="col">
                <Card className="custom-card border">
                  ...
                  <Card.Body>
                    <span className="badge bg-danger blog-badge">
                      Freelancer
                    </span>
                    <h5 className="fw-semibold mb-1">
              ...
              <div className="col">
                <Card className="custom-card border">
                  ...
                  <Card.Body>
                    <span className="badge bg-warning blog-badge">
                      Jobmaster
                    </span>
                    <h5 className="fw-semibold mb-1">
                ...
                <Card className="custom-card text-start featured-card-4">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      ...
                      <h6 className="fw-semibold mb-0">General Questions</h6>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Card className="custom-card text-start featured-card-4">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      ...
                      <h6 className="fw-semibold mb-0">Order & Cart</h6>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Card className="custom-card text-start featured-card-4">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      ...
                      <h6 className="fw-semibold mb-1">Payment & Credits</h6>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Card className="custom-card text-start featured-card-4">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      ...
                      <h6 className="fw-semibold mb-1">Shipping</h6>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Card className="custom-card text-start featured-card-4">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      ...
                      <h6 className="fw-semibold mb-1">Licence</h6>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Card className="custom-card text-start featured-card-4">
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      ...
                      <h6 className="fw-semibold mb-1">Invoice</h6>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
                    ...
                    <Col xxl={4} xl={6} lg={6} md={6} sm={12}>
                      <Card className="custom-card featured-card-1 border">
                        <Card.Body className="p-4">
                          ...
                          <span>
                            - Est amet sit vero sanctus labore no sed ipsum
                            ipsum nonumy. Sit ipsum sanctus ea magna est.
                            Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum
        ...
        <section className="section bg-banner" id="career-advice">
          <div className="row justify-content-center">
            <div className="col-lg-6 text-center">
              ...
              <span className="fs-15 fw-normal op-8 d-block mb-4">
              ...
              <Link to="#" className="btn btn-lg btn-light m-1">
                <i className="bi bi-search me-1"></i> Search Jobs
              </Link>
              <Link to="#" className="btn btn-lg btn-danger m-1">
            ...
            <div className="d-flex flex-wrap gap-2 align-items-center justify-content-between">
              <div>
                <span className="text-fixed-white op-7 fs-14">
                  ...
                  <a href="#" className="text-primary fs-15 fw-semibold">
                    Ynex
                  </a>
                  .
                </span>
              ...
              <div>
                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                  <li>
                    <Link to="#" className="text-fixed-white op-8">
                      Terms Of Service
                    </Link>
                  </li>
                  <li>

  ...
  const fetchDailyData = async (date: Date) => {
    ...
    try {
      const response = await axiosGet(
        `callStatus/getAllAppointmentsDailySelected?date=${formattedDate}`
      );
  ...
  const deleteDailyData = async (deleteId: any) => {
    ...
    try {
      const response = await axiosDelete(
        `callStatus/deleteAppointmentById/${deleteId}`
      );
...
export default AppointmentDailyDate;
